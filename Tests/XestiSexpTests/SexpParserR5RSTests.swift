...
extension SexpParserR5RSTests {
    ...
    func parse_number() throws {
        ...
        try _testParseError("-inf.0")
        try _testParseError("+inf.0")
        try _testParseError("-nan.0")
        try _testParseError("+nan.0")
    }
    ...
    func parse_string() throws {
        ...
        try _testParseError("\"Bilbo \\\"B\\xe4;ggins\\\"\"")
    }

    @Test
    func parse_symbol() throws {
        try _testParse("Frodo", Sexp(symbol: "Frodo"))
        try _testParseError("|Frodo Baggins|")
        try _testParseError("|Frodo \\| \"B\\xe4;ggins\"|")
    }
...
extension SexpParserR5RSTests {
    private func _testParse(_ text: String,
        ...
        let actualSexp = try Sexp.Parser(syntax: .r5rs,
